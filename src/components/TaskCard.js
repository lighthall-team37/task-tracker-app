...
const TaskCard = ({taskObj, index, id, deleteTask, updateListArray}) => {
    ...
    return (
        <div className = "card-wrapper mr-5">
            ...
            <Card sx={{height: `${100}%`}} style={{backgroundColor: colors[index%5].secondaryColor, borderRadius: "10px"}}>
                <CardActionArea sx={{height: `${100}%`}} >
                    <CardContent sx={{height: `${100}%`}} style={{display: "flex", flexDirection: "column", justifyContent: "space-between"}}>
                        ...
                        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                <button className="btn btn-secondary" style={{ backgroundColor: colors[index%5].primaryColor, border: '0px' }}>Due on: {taskObj.dueDate}</button>
                            </Typography>
                            <div>
